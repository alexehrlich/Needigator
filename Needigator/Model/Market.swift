...
struct Market {
    ...
    var end = 0
    var bitMapImageOfNodes = UIImage(named: "knoten")
        ...
        for i in 0..<route.getRoute().count - 1{
            ...
            if route.getRoute()[i].getXPosition() == route.getRoute()[i + 1].getXPosition(){
                ...
                if route.getRoute()[i].getYPosition() < route.getRoute()[i + 1].getYPosition() {
                    ...
                    while pixelBuffer[getCurrentPixelPosition(y: nextY, width: width, x: fixedXPosition)] != .red {
                ...
                if route.getRoute()[i].getXPosition() < route.getRoute()[i + 1].getXPosition(){
                    ...
                    while pixelBuffer[getCurrentPixelPosition(y: fixedYPosition, width: width, x: nextX)] != .red {
